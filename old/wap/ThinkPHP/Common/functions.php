 ...
 * @return void|string
 */
function dump_tp($var, $echo=true, $label=null, $strict=true) {
 ...
 * @return void
 */
function redirect_tp( $url, $time=0, $msg='') {
    //多行URL地址支持
 ...
 * @return mixed
 */
function session_tp( $name,$value='') {
 ...
 * @return mixed
 */
function cookie_tp($name, $value='', $option=null) {
    // 默认设置
    $config = array(
