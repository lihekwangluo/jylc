...
<body>
<div  class="lobab_nav">
<div class="header  daohang"> <div class="fanhui_img"><img onclick="window.history.go(-1);" src="<?php echo ($_static_); ?>/images/fh1.png" /></div>活找队发布 </div>
                   ...
                   <tr>
                       ...
                       <td width="75%">
                           ...
                           <select class="loybn" name="gc_lx" id="gc_lx">
                               ...
                               <?php if(is_array($i_list)): $i = 0; $__LIST__ = $i_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vl): $mod = ($i % 2 );++$i;?><option <?php if($vo['mold'][0][cid] == $vl['id']): ?>selected<?php endif; ?> value="<?php echo ($vl["id"]); ?>"><?php echo ($vl["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                           </select>
                       </td>
                   </tr>
               </table>
    ...
    <td height="50"><table class="biaog" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="75%"><label for="textfield"></label>
          <input type="text" class="loyab" name="gz_zj" id="gz_zj" value="<?php echo ($vo["price"]); ?>" /><!--<span class="loyb_hz">人</span>--> 
          </td>
      </tr>
    </table></td>
  </tr>
