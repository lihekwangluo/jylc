	...
	$(".login_out").click(function(){
		layer.confirm('您确定要退出吗？',  {skin: 'layui-layer-molv',offset: '30%'}, function(index){
			...
			layer.msg('拜拜！欢迎下次光临！', {shift: 6, time: 1500},function(){
				window.location='{$_root}login/logout';
			});
		});
	});
});
...
<div style="position:relative" class="mobile">
     <div class="weixin weixin_fd ">
        <div class="fabu_an"><a  data-toggle="modal"  href="{$_root}member/index/exchange" style="font-size: 14px;color: white;text-decoration: none">邀请有奖</a></div>
        <!--弹出 -->
    </div> 
	<!--页面加载 开始-->
  <div id="preloader">
  ...
  <!--header 结束-->
	...
	<div class="user_top w">
   	  <div class="user_logo"><div class="img"><img src="{$_static_}/images/<if condition='empty($vo[pic])'>geren_03.png<else/>{$vo.pic}</if>"></div></div>
        <div class="user_info">
        	<div class="user_name" style="color:#3e3e3e">{$vo.nickname}</div>
            <div class="user_dengji" style="color:#969696">{$vo.mobile}</div>
        </div>
    </div>
    <div class="user_nav_list w">
    	<ul>
            <li>
            	<a href="{$_root}member/my/publish.html">
            ...
            <li>
            	<a href="{$_root}member/my/collect">
            ...
            <li>
            	<a href="{$_root}member/index/exchange">
            ...
            <li>
            	<a href="{$_root}member/index/renzheng">
            ...
            <li>
            	<a href="{$_root}member/my/suggest">
            ...
            <li>
            	<a href="{$_root}/member/index/about">
  ...
  <div class="footer w">
  	<a href="{$_root}"><div class="ico_img">
      <img src="{$_static_}/images/foot/1f1_45.png"></div><span style="color:#7e7e7e">首页</span></a>

    <a href="{$_root}workmate?status=1"><div class="ico_img">
      <img src="{$_static_}/images/images/tutu_05.png"></div><span style="color:#7e7e7e">工友圈</span></a>
    <a href="{$_root}workmate?status=2"><div class="ico_img">
      <img src="{$_static_}/images/images/tutu_07.png"></div><span style="color:#7e7e7e">子女教育</span></a>
    <a href="javascript:void"><div class="ico_img">
      <img src="{$_static_}/images/foot/1f_51.png"></div><span style="color:#00bb9c">我的</span></a>
  </div>
  </div>
