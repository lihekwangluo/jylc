...
<title><eq name="type" value="1">会员<else/>企业</eq>认证 — 建遇良才</title>
...
<body>
<form action="{$_root}member/index/renzheng" id="uploadForm" name="uploadForm" method="post" enctype="multipart/form-data">
<div style="width:100%; background-color:#FFF;" class="mobile">
	<div class="tou"><a href="javascript:history.back();"><img src="{$_static_}/images/zuo.png" style="margin-top:10px; cursor:pointer; float:left;"></a>  
     <h2>会员认证</h2>
     <if condition="$vo.renzheng neq 1"><a href="javascript:;" onclick="sub()" style="position: absolute;right: 0;top: 0;height: 50px;line-height: 50px;font-size: 20px; margin-right: 10px;color: #fff;">提交</a></if>
  </div>
  <div class="nei3">
    <p><span style="font-size:14px;">姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</span><span style="  border-left:1px solid #e5e5e5;padding-left:16px;margin-left:16px;">
      <input type="text" id="name" name="name" value="{$vo.name}" style="border:none; line-height:30px;"/></span></p>
  <p><span style="font-size:14px;">身份证件</span>
    <span style="border-left:1px solid #e5e5e5;padding-left:16px;margin-left:16px;">
    <input type="text" id="idcard" name="idcard" value="{$vo.idcard}" style="border:none; line-height:30px;"/></span></p></div>
  ...
  <div class="nei21_1">
    ...
    <p class="upload-img">
      ...
      <img class="add" src="<if condition='empty($vo[enterprisepic])'>{$_static_}/images/images/jia_03.png<else/>{$vo.enterprisepic}</if>" style="margin-top:0;"></p>
  </div>
  </eq>
  ...
  <div class="nei21_1" style="padding-bottom: 40px;">
    ...
    <p class="upload-img">
      ...
      <img class="add" src="<if condition='empty($vo[cardzpic])'>{$_static_}/images/images/jia_03.png<else/>{$vo.cardzpic}</if>" style="margin-top:0;"></p>
    <p class="upload-img">
      <input type="file" id="idcard_2" name="idcard_2" class="comment-pic-upd" />
      <img class="add" src="<if condition='empty($vo[cardfpic])'>{$_static_}/images/images/jia_03.png<else/>{$vo.cardfpic}</if>" style="margin-top:0;"></p></div>
</div>
