...
<body>
<div  class="lobab_nav">
<div class="header  daohang"> <div class="fanhui_img"><img onclick="window.history.go(-1);" src="{$_static_}/images/fh1.png" /></div>队找活发布 </div>
 ...
 <td height="50"><table class="biaog" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="75%"><label for="textfield"></label>
          <input type="text" class="loyab" name="duiw_rs" id="duiw_rs" value="{$vo.num}" /><span class="loyb_hz">人</span>
          </td>
      </tr>
    </table>
  ...
  <tr>
    <td height="50"><table class="biaog" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="335"><input type="button"  class="fb_ok" onclick="sub()" id="ok" value="<gt name='vo[pid]' value='0'>修改<else/>发布</gt>" /></td>
      </tr>
    </table></td>
  </tr>
   </table>
