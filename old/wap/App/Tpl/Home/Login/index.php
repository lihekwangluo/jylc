...
<link href="{$_static_}/frozenui/css/frozen.css" rel="stylesheet" type="text/css">
    ...
    <form id="frm_login" method="get" action="">
        ...
        <div class="item item-login-option">
          <div class="aoutlogin">
            ...
            <span class="retrieve-password"> <a class="" href="{$_root}index/forgetpwd">忘记密码</a> </span>
        </div>
        <div class="ui-btn-wrap"><input name="" type="submit" value="用户登录"  class="ui-btn-lg ui-btn-primary" /> </div>
        <div class="ui-btn-wrap"> <a class="ui-btn-lg ui-btn-danger" href="{$_root}register">没有账号？立即注册</a> </div>
    ...
    W.widget.connectButton({
        ...
        callback: {
            ...
            logout: function () { //退出后的回调函数
                window.location.href="{$_root}login/logout";
            }
        }
    });
});
$("#sina").click(function(){ 
    ...
    location.href = 'https://api.weibo.com/oauth2/authorize?client_id=' + '3602390774' + '&client_secrect=' + '6fee7568d4e413c568101c5baa1ccec2' + '&response_type=code&redirect_uri=' + "{$_root}member";

});

$("#qq").click(function(){
    window.location.href= "{$_root}login/get_openid";
})
