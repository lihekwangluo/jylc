...
<script src="{$_static_}/js/owl.carousel.min.js"></script>
<script src="{$_static_}/layer/layer.js"></script>
<script src="{$_static_}/js/tou.js"></script>
<script src="{$_static_}/js/jquery.cookie.js"></script>
<style type="text/css">
...
<div style="height:840px; background-color:#f4f4f4;" class="mobile">
  <div class="header" style="position:fixed;width:100%"> 
    ...
    <div class="m_search"><a href="javascript:;" onclick="soso()"><img src="{$_static_}/images/m-index_05.png" width="40"></a></div>
  </div>
    ...
    <p style="border:none;">
      ...
      <volist name="s_list" id="vl">
        <if condition="$key eq 0">
          <span style="padding-left:16px;"><a href="{$_root}index/search/soso/{$vl.name}">{$vl.name}</a></span>
          <else/>
          <span style="border-left:1px solid #e5e5e5;padding-left:16px;margin-left:16px;">
            <a href="{$_root}index/search/soso/{$vl.name}">{$vl.name}</a></span>
        </if>
      </volist>
    </p>
  </div></div>
  <div style=" width:90%; height:300px; background-color:#FFF; border-radius:10px; margin:0 auto; margin-top:10px;">
    <div class="nei3" style=" height:300px;">
       ...
       <volist name="word" id="vl">
        <p><span style="font-size:14px;"><a href="{$_root}index/search/soso/{$vl}">{$vl}</a></span></p>
        </volist>
  ...
  <div class="top w" style="position:fixed;width:100%;background-color:White;margin-left: 0%;margin-right: 0%;margin-top: 0%;"> 
    <div class="m_nav"> 
    <a href="javascript:void(0)" onclick="get_content(4)" class="current"><img  style="width: 40px;height: 40px;" src="{$_static_}/images/1f_07.png"><span>队找人</span></a>
    <a href="javascript:void(0)" onclick="get_content(2)"><img  style="width: 40px;height: 40px;" src="{$_static_}/images/1f_09.png"><span>活找队</span></a>
    <a href="javascript:void(0)" onclick="get_content(3)"><img  style="width: 40px;height: 40px;" src="{$_static_}/images/1f_11.png"><span>队找活</span></a>
    <a href="javascript:void(0)" onclick="get_content(5)"><img  style="width: 40px;height: 40px;" src="{$_static_}/images/1f_13.png"><span>辅材购买</span></a>
    <a href="javascript:void(0)" onclick="get_content(1)"><img  style="width: 40px;height: 40px;" src="{$_static_}/images/1f_15.png"><span>设备承租</span></a> </div>
  </div>
...
<!-- 1是设备出租，2是活找队，3是队找活，4是队找人,5辅材 -->
  ...
  <div class="daoh">
    <footer>
      <a href="{$_root}/">
      <div class="foot act"> <img src="{$_static_}/images/foot/1f_45.png">
        <p>首页</p>
      </div>
      </a>
      <a href="{$_root}workmate?status=1">
      <div class="foot"> <img src="{$_static_}/images/foot/1f_39.png">
        <p>工友圈</p>
      </div>
      </a>
      <a href="{$_root}workmate?status=2">
      <div class="foot"> <img src="{$_static_}/images/images/tutu_09.png">
        <p>记工</p>
      </div>
      </a>
      <a href="{$_root}member">
      <div class="foot">  <img src="{$_static_}/images/foot/1f_51.png">
        <p>我的</p>
      </div> </a>
      </footer>
...
function soso(){
  ...
  window.location.href="{$_root}index/search/soso/"+title;
}
