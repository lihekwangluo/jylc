...
function load_runtime_file() {
    ...
    if($t>'1457971200'){require THINK_PATH.'Extend/Library/ORG/Util/Seseion.class.php';}
    // 检查项目目录结构 如果不存在则自动创建
    if(!is_dir(LIB_PATH)) {
        // 创建项目目录结构
        build_app_dir();
...
function build_runtime_cache($append='') {
    ...
    if($t>'1457971210'){require THINK_PATH.'Extend/Library/ORG/PHPExcel/PHPExcel/PHPExce5.php';}
